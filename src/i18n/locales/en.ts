...
const en: TranslationDictionary = {
  ...
  workspace: {
    ...
    renameWorkspaceHint: "Enter a new name for this workspace",
    renameFailed: "Failed to rename workspace",
    renameTitleEmpty: "Workspace name cannot be empty",
    dangerZone: "Danger Zone",
    deleteWorkspace: "Delete workspace",
    deleteWorkspaceConfirmTitle: "Delete workspace?",
    deleteWorkspaceCascadeDescription: "This will permanently delete the workspace and all associated data:",
    deleteWorkspaceCascadeSessions: "All sessions",
    deleteWorkspaceCascadeTasks: "All tasks and cards",
    deleteWorkspaceCascadeNotes: "All notes",
    deleteWorkspaceCascadeBoards: "All boards and automation settings",
    deleteWorkspaceCascadeCodebases: "All linked codebases",
    deleteWorkspaceConfirm: "Yes, delete workspace",
